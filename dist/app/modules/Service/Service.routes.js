...
router.post('/', fileUploader_1.fileUploader.uploadInstituteFile, Service_controller_1.ServiceController.createService);
// Get all services
...
router.put('/:id', fileUploader_1.fileUploader.uploadInstituteFile, Service_controller_1.ServiceController.updateService);
